...
imageAlt: 'Intel Xe XMX engine diagram showing DPAS systolic array dot product accumulate operation'
description: 'How Intel DPAS instructions on XMX engines accelerate matrix multiplication — from vec4 basics to tiled 100x100 matrix operations.'
